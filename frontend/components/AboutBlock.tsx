...
export function AboutBlock() {
  return (
    <>
      <div className="space-y-3 text-center max-w-200 mx-auto">
        <Chip text="кто мы" className="bg-accent" />
        <h3 className="text-3xl leading-10 text-pretty  font-medium">
      ...
      <div className="space-y-8">
        ...
        <div className="flex items-center justify-around">
          ...
          <div className="flex flex-col gap-2 items-center group">
            <div className="size-16 rounded-full bg-gray-200 flex items-center justify-center group-hover:-translate-y-3 duration-200">
              <IconQuestionMark className="text-gray-400 size-10" />
            </div>
            <span className="font-medium">Что-то еще</span>
          </div>
        </div>
      </div>
    </>
